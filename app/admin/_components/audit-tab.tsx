// app/admin/_components/audit-tab.tsx
...
export default async function AuditTab() {
    ...
    return (
        <div className='bg-card rounded-lg border p-6 shadow-sm'>
            <div className='mb-6'>
                <h2 className='text-2xl font-semibold'>System Audit Log</h2>
            </div>
            <Table>
                <TableHeader>
                    <TableRow>
                            ...
                            <TableCell>
                                {entry.assigned_by_name ? (
                                    <>
                                        {entry.assigned_by_name}
                                        <br />
                                        <span className='text-muted-foreground text-xs'>{entry.assigned_by_email}</span>
                                    </>
                                ) : (
